...
const claimed = new Map(); // userId -> Set(bonusId)
...
export function listBonuses(userId) {
  const set = claimed.get(userId) || new Set();
...
export function claimBonus(userId, bonusId) {
