import type { CasinoGame, CasinoCategory } from '../../../shared/types.js';
...
export const CASINO_GAMES: CasinoGame[] = [
  { id: 'crash', name: 'Crash', provider: 'Crow Originals', category: 'originals', rtp: 99, route: '/crash', accent: '#e8b923', tag: 'LIVE' },
  { id: 'roulette', name: 'X-Roulette', provider: 'Crow Originals', category: 'originals', rtp: 97, route: '/roulette', accent: '#19c964', tag: 'LIVE' },
  { id: 'dice', name: 'Dice', provider: 'Crow Originals', category: 'originals', rtp: 99, route: '/casino/dice', accent: '#f0a52e', tag: 'INSTANT' },
  { id: 'jackpot', name: 'Jackpot', provider: 'Crow Originals', category: 'originals', rtp: 95, route: '/jackpot', accent: '#ffc233', tag: 'POOL' },
  { id: 'mines', name: 'Mines', provider: 'Crow Originals', category: 'originals', rtp: 99, external: true, accent: '#3aa0ff' },
