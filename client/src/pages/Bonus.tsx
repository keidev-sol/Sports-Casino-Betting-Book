...
import type { Bonus as BonusType } from '@shared/types';

const ICONS: Record<string, (p: import('react').SVGProps<SVGSVGElement>) => JSX.Element> = {
  welcome: Icon.Gift,
  rakeback: Icon.Bolt,
  daily: Icon.Star,
  weekly: Icon.Wallet,
